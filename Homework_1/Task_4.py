...
if profit > costs:
    print(f'Финансовый результат - прибыль. Её величина: {profit - costs:.2f}')
    print(f'Рентабельность выручки - {(profit - costs) / profit:.2f}')
    workers = int(input('Введите численность сотрудников фирмы: '))
    print(f'Прибыль фирмы в раcчете на одного сотрудника = {(profit - costs) / workers:.2f}')
else:
